...
def test_v0_2_qualification_workflow_is_manual_narrow_and_prefinal_only() -> None:
...
def test_v0_2_workflow_has_no_exchange_secret_or_private_execution_surface() -> None:
    text = _WORKFLOW.read_text(encoding="utf-8")
    lowered = text.lower()
